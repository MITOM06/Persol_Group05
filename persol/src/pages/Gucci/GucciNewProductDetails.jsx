...
const GucciNewProductDetails = ({ GucciNewProductDetails }) => {
  ...
  useEffect(() => {
    ...
    const foundProduct = GucciNewProductDetails.find((p) => p.id === parseInt(id));
    setProduct(foundProduct);
  }, [id, GucciNewProductDetails]);
...
export default GucciNewProductDetails ;
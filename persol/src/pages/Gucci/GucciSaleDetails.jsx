...
const GucciSaleProductDetails = ({ GucciSaleProductDetails }) => {
  ...
  useEffect(() => {
    ...
    const foundProduct = GucciSaleProductDetails.find((p) => p.id === parseInt(id));
    setProduct(foundProduct);
  }, [id, GucciSaleProductDetails]);
      ...
      <div className="BackGroundDetails">
        ...
        <table className="DetailsContainer1">
          ...
          <div className="GucciDetailsRight">
            ...
            <div style={{ color: '#555555', textDecoration: 'line-through' }}>{product.oldprice}</div>
...
export default GucciSaleProductDetails;
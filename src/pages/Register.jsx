                                ...
                                <div className="overlap-group-x">
                                    ...
                                    <div className="overlap-2">
                                        <div className="name">
                                            ...
                                            <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} className="fill-confirmpass" placeholder='Confirm Password' />

                                            <input type="text" name="email" value={formData.email} onChange={handleChange} className="fill-email" placeholder='Enter Email' />
                                            </div>
                                    ...
                                    <div className="overlap-3">
                                        <div className="name-">
                                            ...
                                            <input type="text" name="name" value={formData.name} onChange={handleChange} className="fill-name" placeholder='Enter Username' />

                                            <input type="password" name="password" value={formData.password} onChange={handleChange} className="fill-pass" placeholder='Enter Password' />
                                   ...
                                   <div className="text-pass">
                                    ...
                                    {/* <div className="text-address1">ADDRESS:</div>
                                    <input type="text" name="address" value={formData.address} onChange={handleChange} className="fill-address" placeholder='Enter Address' /> */}

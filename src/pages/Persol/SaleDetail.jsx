...
const SaleDetail = () => {
  ...
  // Xử lý ADD TO CART: lưu sản phẩm vào localStorage với thuộc tính "image" lấy từ product.image1,
  // và sử dụng product.newPrice nếu có (giá mới) hoặc product.price nếu không

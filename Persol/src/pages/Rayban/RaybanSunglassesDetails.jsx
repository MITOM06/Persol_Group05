...
const RaybanSunglassesDetails = ({ RaybanSunglassesDetails }) => {
  ...
  useEffect(() => {
    ...
    const foundProduct = RaybanSunglassesDetails.find((p) => p.id === parseInt(id));
    setProduct(foundProduct);



  }, [id, RaybanSunglassesDetails]);
...
export default RaybanSunglassesDetails;
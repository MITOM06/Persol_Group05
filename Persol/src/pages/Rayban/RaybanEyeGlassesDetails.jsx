...
const RaybanEyeGlassesDetails = ({ RaybanEyeGlassesDetails }) => {
  ...
  useEffect(() => {
    ...
    const foundProduct = RaybanEyeGlassesDetails.find((p) => p.id === parseInt(id));
    setProduct(foundProduct);  
  }, [id, RaybanEyeGlassesDetails]);
   ...
   {details && (
            <div className="rayban-dropdown-details">
              ...
              <h4>Model: {product.model}</h4>
               ...
               <button className="rayban-btn-download">Download</button>
            </div>
          )}
</div>
...
export default RaybanEyeGlassesDetails;